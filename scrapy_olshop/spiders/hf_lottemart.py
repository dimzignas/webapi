...
class HfLotteMartSpider(CrawlSpider):
    name = 'hf-lottemart'
    allowed_domains = ['happyfresh.id']
    start_urls = [
        'https://www.happyfresh.id/lotte-mart-festival-citylink/fresh-fruits-3/',
        'https://www.happyfresh.id/lotte-mart-festival-citylink/fresh-vegetables-4/',
        'https://www.happyfresh.id/lotte-mart-festival-citylink/fresh-herbs-5/',
        'https://www.happyfresh.id/lotte-mart-festival-citylink/packaged-fruit-vegetables-6/',
        'https://www.happyfresh.id/lotte-mart-festival-citylink/organic-fresh-produce-472/',
        'https://www.happyfresh.id/lotte-mart-festival-citylink/organic-dairy-beverages-473/',
        'https://www.happyfresh.id/lotte-mart-festival-citylink/organic-pantry-supplies-476/',
        'https://www.happyfresh.id/lotte-mart-festival-citylink/dairy-eggs-24/',
        'https://www.happyfresh.id/lotte-mart-festival-citylink/pantry-48/',
        'https://www.happyfresh.id/lotte-mart-festival-citylink/dry-canned-goods-34/',
        'https://www.happyfresh.id/lotte-mart-festival-citylink/meat-seafood-7/',
        'https://www.happyfresh.id/lotte-mart-festival-citylink/frozen-70/',
        'https://www.happyfresh.id/lotte-mart-festival-citylink/deli-13/',
        'https://www.happyfresh.id/lotte-mart-festival-citylink/bakery-19/',
        'https://www.happyfresh.id/lotte-mart-festival-citylink/beverages-53/',
        'https://www.happyfresh.id/lotte-mart-festival-citylink/snacks-60/',
    ]
    ...
    def parse_produk(self, response):
        ...
        yield {
            ...
            'qty_unit': qty_unit,
            'username': 'Lotte Mart Festival Citylink',
            'link_toko': 'https://www.happyfresh.id/lotte-mart-festival-citylink/',
        }
