...
class HfSuperIndoDagoSpider(CrawlSpider):
    name = 'hf-papayafg'
    allowed_domains = ['happyfresh.id']
    start_urls = [
        'https://www.happyfresh.id/papaya-fresh-gallery-sukajadi/fresh-produce-2/',
        'https://www.happyfresh.id/papaya-fresh-gallery-sukajadi/fresh-fruits-3/',
        'https://www.happyfresh.id/papaya-fresh-gallery-sukajadi/fresh-vegetables-4/',
        'https://www.happyfresh.id/papaya-fresh-gallery-sukajadi/fresh-herbs-5/',
        'https://www.happyfresh.id/papaya-fresh-gallery-sukajadi/packaged-fruit-vegetables-6/',
        'https://www.happyfresh.id/papaya-fresh-gallery-sukajadi/organic-fresh-produce-472/',
        'https://www.happyfresh.id/papaya-fresh-gallery-sukajadi/organic-pantry-supplies-476/',
        'https://www.happyfresh.id/papaya-fresh-gallery-sukajadi/dairy-eggs-24/',
        'https://www.happyfresh.id/papaya-fresh-gallery-sukajadi/pantry-48/',
        'https://www.happyfresh.id/papaya-fresh-gallery-sukajadi/dry-canned-goods-34/',
        'https://www.happyfresh.id/papaya-fresh-gallery-sukajadi/meat-seafood-7/',
        'https://www.happyfresh.id/papaya-fresh-gallery-sukajadi/frozen-70/',
        'https://www.happyfresh.id/papaya-fresh-gallery-sukajadi/deli-13/',
        'https://www.happyfresh.id/papaya-fresh-gallery-sukajadi/bakery-19/',
        'https://www.happyfresh.id/papaya-fresh-gallery-sukajadi/beverages-53/',
        'https://www.happyfresh.id/papaya-fresh-gallery-sukajadi/snacks-60/',
        'https://www.happyfresh.id/papaya-fresh-gallery-sukajadi/organic-snacks-desserts-477/',
    ]
    ...
    def parse_produk(self, response):
        ...
        yield {
            ...
            'qty_unit': qty_unit,
            'username': 'Papaya Fresh Gallery Sukajadi',
            'link_toko': 'https://www.happyfresh.id/papaya-fresh-gallery-sukajadi/',
        }
