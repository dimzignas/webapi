...
class HfSuperIndoDagoSpider(CrawlSpider):
    ...
    start_urls = [
        'https://www.happyfresh.id/super-indo-dago/fresh-produce-2/',
        'https://www.happyfresh.id/super-indo-dago/fresh-fruits-3/',
        'https://www.happyfresh.id/super-indo-dago/fresh-vegetables-4/',
        'https://www.happyfresh.id/super-indo-dago/fresh-herbs-5/',
        'https://www.happyfresh.id/super-indo-dago/packaged-fruit-vegetables-6/',
        'https://www.happyfresh.id/super-indo-dago/organic-fresh-produce-472/',
        'https://www.happyfresh.id/super-indo-dago/organic-pantry-supplies-476/',
        'https://www.happyfresh.id/super-indo-dago/dairy-eggs-24/',
        'https://www.happyfresh.id/super-indo-dago/pantry-48/',
        'https://www.happyfresh.id/super-indo-dago/dry-canned-goods-34/',
        'https://www.happyfresh.id/super-indo-dago/meat-seafood-7/',
        'https://www.happyfresh.id/super-indo-dago/frozen-70/',
        'https://www.happyfresh.id/super-indo-dago/deli-13/',
        'https://www.happyfresh.id/super-indo-dago/bakery-19/',
        'https://www.happyfresh.id/super-indo-dago/beverages-53/',
        'https://www.happyfresh.id/super-indo-dago/snacks-60/',
        'https://www.happyfresh.id/super-indo-dago/organic-snacks-desserts-477/',
    ]
    ...
    def parse_produk(self, response):
        ...
        yield {
            ...
            'qty_unit': qty_unit,
            'username': 'Super Indo Dago',
            'link_toko': 'https://www.happyfresh.id/super-indo-dago/',
        }
