...
class HfSuperIndoMetroSpider(CrawlSpider):
    name = 'hf-simetro'
    allowed_domains = ['happyfresh.id']
    start_urls = [
        'https://www.happyfresh.id/super-indo-metro/fresh-produce-2/',
        'https://www.happyfresh.id/super-indo-metro/fresh-fruits-3/',
        'https://www.happyfresh.id/super-indo-metro/fresh-vegetables-4/',
        'https://www.happyfresh.id/super-indo-metro/fresh-herbs-5/',
        'https://www.happyfresh.id/super-indo-metro/packaged-fruit-vegetables-6/',
        'https://www.happyfresh.id/super-indo-metro/organic-fresh-produce-472/',
        'https://www.happyfresh.id/super-indo-metro/organic-pantry-supplies-476/',
        'https://www.happyfresh.id/super-indo-metro/dairy-eggs-24/',
        'https://www.happyfresh.id/super-indo-metro/pantry-48/',
        'https://www.happyfresh.id/super-indo-metro/dry-canned-goods-34/',
        'https://www.happyfresh.id/super-indo-metro/meat-seafood-7/',
        'https://www.happyfresh.id/super-indo-metro/frozen-70/',
        'https://www.happyfresh.id/super-indo-metro/deli-13/',
        'https://www.happyfresh.id/super-indo-metro/bakery-19/',
        'https://www.happyfresh.id/super-indo-metro/beverages-53/',
        'https://www.happyfresh.id/super-indo-metro/snacks-60/',
        'https://www.happyfresh.id/super-indo-metro/organic-snacks-desserts-477/'
    ]
    ...
    def parse_produk(self, response):
        ...
        yield {
            ...
            'qty_unit': qty_unit,
            'username': 'Super Indo Metro',
            'link_toko': 'https://www.happyfresh.id/super-indo-metro/',
        }
