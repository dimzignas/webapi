...
class HfHeropaskalSpider(CrawlSpider):
    name = 'hf-heropaskal'
    allowed_domains = ['happyfresh.id']
    start_urls = [
        'https://www.happyfresh.id/hero-paskal-hypersquare/fresh-produce-2/',
        'https://www.happyfresh.id/hero-paskal-hypersquare/fresh-fruits-3/',
        'https://www.happyfresh.id/hero-paskal-hypersquare/fresh-vegetables-4/',
        'https://www.happyfresh.id/hero-paskal-hypersquare/packaged-fruit-vegetables-6/',
        'https://www.happyfresh.id/hero-paskal-hypersquare/organic-fresh-produce-472/',
        'https://www.happyfresh.id/hero-paskal-hypersquare/organic-dairy-beverages-473/',
        'https://www.happyfresh.id/hero-paskal-hypersquare/organic-pantry-supplies-476/',
        'https://www.happyfresh.id/hero-paskal-hypersquare/dairy-eggs-24/',
        'https://www.happyfresh.id/hero-paskal-hypersquare/pantry-48/',
        'https://www.happyfresh.id/hero-paskal-hypersquare/dry-canned-goods-34/',
        'https://www.happyfresh.id/hero-paskal-hypersquare/meat-seafood-7/',
        'https://www.happyfresh.id/hero-paskal-hypersquare/frozen-70/',
        'https://www.happyfresh.id/hero-paskal-hypersquare/deli-13/',
        'https://www.happyfresh.id/hero-paskal-hypersquare/bakery-19/',
        'https://www.happyfresh.id/hero-paskal-hypersquare/beverages-53/',
        'https://www.happyfresh.id/hero-paskal-hypersquare/snacks-60/',
        'https://www.happyfresh.id/hero-paskal-hypersquare/organic-snacks-desserts-477/',
    ]
