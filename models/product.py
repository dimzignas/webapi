...
class Product(Model):
    ...
    @staticmethod
    @requires_login
    def read_all(f: List, v: List, sort: List = None, offset: int = 0, limit: int = 10):
    ...
    @staticmethod
    @requires_login
    def read_resep(q: str, sort: List = None, offset: int = 0, limit: int = 10):
    ...
    @staticmethod
    @requires_login
    def read_komplemen(q: str, sort: List = None, offset: int = 0, limit: int = 10):
